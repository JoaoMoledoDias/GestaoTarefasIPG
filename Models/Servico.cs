...
namespace GestaoTarefasIPG.Models
{
    public class Servico
    {
        ...
        [RegularExpression(@"^[a-zA-ZÀ-ÿ0-9]*$", ErrorMessage = "Por favor introduza uma Descrição válida!")]
        ...
        [RegularExpression(@"^[a-zA-ZÀ-ÿ0-9]*$", ErrorMessage = "Por favor introduza uma Localização válida!")]
